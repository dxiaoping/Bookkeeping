...
public class Outcome extends JPanel {
	...
	public Outcome() {
		...
		List<Bill> bills = new Service().getBillList("支出");
		Bill bill = null;
...
//		JPanel jPanelBill = new JPanel();
//		jPanelBill.setLayout(null);
//		jPanelBill.setBounds(0,0,582,50);
//		JLabel label_1 = new JLabel("账单名称");
//		label_1.setHorizontalAlignment(SwingConstants.CENTER);
//		label_1.setBackground(Color.cyan);
//		label_1.setBounds(0, 0, 80, 50);
//		jPanelBill.add(label_1);
//		
//		JLabel label_2 = new JLabel("账单类型");
//		label_2.setHorizontalAlignment(SwingConstants.CENTER);
//		label_2.setBackground(Color.cyan);
//		label_2.setBounds(80, 0, 80, 50);
//		jPanelBill.add(label_2);
//		
//		JLabel label_3 = new JLabel("账单类别");
//		label_3.setHorizontalAlignment(SwingConstants.CENTER);
//		label_3.setBackground(Color.cyan);
//		label_3.setBounds(80*2, 0, 80, 50);
//		jPanelBill.add(label_3);
//		
//		JLabel label_4 = new JLabel("金额");
//		label_4.setHorizontalAlignment(SwingConstants.CENTER);
//		label_4.setBackground(Color.cyan);
//		label_4.setBounds(80*3, 0, 80, 50);
//		jPanelBill.add(label_4);
//		
//		JLabel label_5 = new JLabel("支出时间");
//		label_5.setHorizontalAlignment(SwingConstants.CENTER);
//		label_5.setBackground(Color.cyan);
//		label_5.setBounds(80*4, 0, 80+50, 50);
//		jPanelBill.add(label_5);
//		
//		JLabel label_6 = new JLabel("创建时间");
//		label_6.setHorizontalAlignment(SwingConstants.CENTER);
//		label_6.setBackground(Color.cyan);
//		label_6.setBounds(80*5+50, 0, 80+50, 50);
//		jPanelBill.add(label_6);
//		
//		
//		jPanelBill.setBackground(new Color(135, 206, 235));
